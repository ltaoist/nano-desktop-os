import{a as e,c as t,i as n,l as r,n as i,o as a,r as o,s,t as c}from"./app-DaBnlJLR.js";var l=JSON.parse(`{"path":"/dev/debug-install.html","title":"安装与分发","lang":"en-US","frontmatter":{},"git":{},"filePathRelative":"dev/debug-install.md"}`),u={name:`debug-install.md`};function d(c,l,u,d,f,p){let m=t(`RouteLink`);return s(),o(`div`,null,[l[6]||=n(`<h1 id="安装与分发" tabindex="-1"><a class="header-anchor" href="#安装与分发"><span>安装与分发</span></a></h1><p>将应用目录（<code>.App</code> 或 <code>.py</code>）复制到 <code>Data/AppData/</code> 下即完成安装，重启服务或刷新页面后应用出现在启动器中。<code>Data/AppData/</code> 目录下可同时放置多个应用：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">Data/</span>
